...
const ConfirmedVehicle = (props) => {
  return (
    <>
      <h1
        onClick={() => props.setConfirmVehiclePannel(false)}
      ...
      <h1 className="text-lg font-bold p-2">Confirm your Ride</h1>
      <div>
        ...
        <div>
          ...
          <button onClick={()=>{
            props.setLookingForDirverPannel(true);
            props.setConfirmVehiclePannel(false);
            }} className="w-full bg-green-600 text-white p-2 font-semibold rounded-xl active:bg-black active:text-white hover:bg-white hover:text-black">
            Confirm
          </button>
        </div>
      </div>
